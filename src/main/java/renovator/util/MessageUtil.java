...
import renovator.pojo.message.req.VideoMessage;
import renovator.pojo.message.req.VoiceMessage;
import renovator.pojo.message.resp.Article;
import renovator.pojo.message.resp.ImageMessage;
import renovator.pojo.message.resp.MusicMessage;
